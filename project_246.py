...
def ethereum_block():
	...
	gas_price_in_dollar = gas_price_in_ether*1321.77
	gas_price_in_rupees = gas_price_in_ether*109151.08
	gas_price_in_pounds = gas_price_in_ether*1070.85
	# Start code for Task 3 below
	value_in_ether["text"] = "Value of gas in Ether: ETH " +str(gas_price_in_ether)
	value_in_dollar["text"] = "Value of gas in Dollars: $" +str(gas_price_in_dollar)
